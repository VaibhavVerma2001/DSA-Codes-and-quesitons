...
class Solution {
  public:
    // Logic - first sum smallest numbers 
    // create min-heap and pop first 2 elements, sum them and push again
    // keep on doing this till array has > 1 elements
